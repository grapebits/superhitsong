...
<head>
<title>
<?php echo $site_name; ?> ::: GrapeBits : Latest SuperHit Song.
</title>
...
<link rel="shortcut icon" href="image/song.jpg" />
...
echo("<marquee><b><center>{$row['text']}</center></b></marquee></span></div>");
}
?>

<center><?php include "adds/add1.php"; ?></center>
